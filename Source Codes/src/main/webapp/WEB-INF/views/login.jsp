...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	...
	<body class="is-preload">
        ...
        <section class="box search">
						<label>Email</label>
			<form:input type="email" class="text" path="email" placeholder="Enter Email" required="required"/>
         </section>
         <section class="box search">
						<label>Password</label>
		<form:input type="password" class="text" path="password" placeholder="Enter Password" required="required"/>
         </section>
