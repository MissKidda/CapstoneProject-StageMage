...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	...
	<body class="is-preload">
		...
		<!-- Content -->
		 ...
		 <div >				
		<form:form action="/addEvent" method="post" modelAttribute="admin">
       ...
       <section class="box search">
		...
		<form:input type="text" class="text" path="nickName" placeholder="Enter a User Name" required="required"/>
         </section>
           <section class="box search">
						<label>About</label>
		<form:input type="text" class="text" path="location" placeholder="Enter Location" required="required"/>
         </section>
         <form:input type="submit" class="button submit"/>
      </form:form>
				...
				<!-- Nav -->
					<nav id="nav">
						<ul>
							...
							<li class="current" ><a href="registerUser">REGISTER</a></li>
